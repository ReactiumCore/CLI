...
module.exports = (spinner) => {
    ...
    return {
        ...
        functional: ({ action, params, props }) => generate({
            action, params, props, templateFile: 'index-functional', fileName: 'index.js',
        }),

        'class': ({ action, params, props }) => generate({
            action, params, props, templateFile: 'index-class', fileName: 'index.js',
        }),

        redux: ({ action, params, props }) => generate({
            action, params, props, templateFile: 'index-redux', fileName: 'index.js',
        }),

        subclass: ({ action, params, props }) => generate({
            action, params, props, templateFile: 'index-class', fileName: `${params.name}.js`,
        }),

        actions: ({ action, params, props }) => generate({
            action, params, props, templateFile: 'actions', fileName: 'actions.js',
        }),

        actionTypes: ({ action, params, props }) => generate({
            action, params, props, templateFile: 'actionTypes', fileName: 'actionTypes.js',
        }),

        reducers: ({ action, params, props }) => generate({
            action, params, props, templateFile: 'reducers', fileName: 'reducers.js',
        }),
        ...
        route: ({ action, params, props }) => {
            ...
            return generate({
                action, params, props, templateFile: 'route', fileName: 'route.js',
            });
        },

        services: ({ action, params, props }) => generate({
            action, params, props, templateFile: 'services', fileName: 'services.js',
        }),

        state: ({ action, params, props }) => generate({
            action, params, props, templateFile: 'state', fileName: 'state.js',
        }),
    };
};
